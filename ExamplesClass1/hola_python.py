...
# 1. Imprimiendo una matriz de caracteres pero con una de las diagonales
for fila in range(0, tamano):
    lista_fila = ""
    for columna in range(0, tamano):
        if fila == columna:
            lista_fila += "[0]"
        elif fila + columna == tamano - 1:
            lista_fila += "[0]"
        else:
            lista_fila += "[*]"
    print(lista_fila)
...
# 2. Imprimiendo una matriz de caracteres pero con una de las diagonales
for fila in range(0, tamano):
    lista_fila = ""
    for columna in range(0, tamano):
        if fila == columna:
            ...
            lista_fila += "[0]"
        elif fila < columna < (tamano - (fila + 1)):
            lista_fila += "[0]"
        elif fila > columna > (tamano - (fila + 1)):
            lista_fila += "[0]"
        else:
...
# 3. Imprimiendo una matriz de caracteres pero con una de las diagonales
print("\n\n Punto 2 \n \n")
...
for fila in range(0, tamano):
    ...
    for columna in range(0, tamano):
        if fila == columna:
           lista_fila += "[0]"
        elif fila > columna > (tamano - (fila + tamano)):
            lista_fila += "[0]"
        else:
             lista_fila += "[*]"
    print(lista_fila)
